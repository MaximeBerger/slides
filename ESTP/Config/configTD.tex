...
% Définition de la variable pour afficher les corrections (lue dans \jobname.adr)
\newboolean{showSolutions}
\input \jobname.adr

% En mode énoncé (showSolutions = false), le corps des solutions est entièrement omis.
\NewEnviron{solution}{%
