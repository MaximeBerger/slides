...
\begin{enumerate}
    ...
    \item Calculer $\langle H + 2\delta_{-\pi}, \varphi \rangle$ pour $\varphi(x) = \cos(x)$.
    
    \ifthenelse{\boolean{showSolutions}}{
    \begin{solution}
        $\langle H + 2\delta_{-\pi}, \varphi \rangle = \langle H, \varphi \rangle + 2\langle \delta_{-\pi}, \varphi \rangle = 1 + 2\cos(-\pi) = 1 + 2(-1) = -1$.
    \end{solution}
    }{}
