...
Cette équation modélise par exemple un système linéaire du premier ordre (circuit RC, système mécanique amorti) soumis à une impulsion instantanée à $t = 0$. Le terme $\delta_0$ représente une excitation de durée infiniment courte mais d'intensité infinie (comme un choc ou une décharge électrique).
