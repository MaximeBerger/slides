...
\textbf{Interprétation :} Une distribution attribue un nombre réel à chaque fonction test. C'est une façon de \og  sonder \fg{}  un objet mathématique avec des fonctions lisses localisées.
...
\begin{enumerate}
    ...
    \item Soit la fonction \og  rampe \fg{}  $R(x) = x \cdot H(x) = \max(0, x)$.
...
\begin{enumerate}
    ...
    \begin{solution}
        ...
        \textbf{Interprétation :} Le peigne de Dirac \og  échantillonne \fg{}  la fonction $\varphi$ aux points $nT$.
    \end{solution}
    }{}
    ...
    \begin{solution}
        ...
        C'est un \og  peigne de doublets \fg{} .
    \end{solution}
    }{}
    ...
    \begin{solution}
        ...
        \textbf{Interprétation :} $f_e$ est une \og  version discrète \fg{}  de $f$, constituée de Diracs pondérés par les valeurs de $f$ aux points d'échantillonnage.
    \end{solution}
    }{}
\end{enumerate}
