...
% Surcharge locale des environnements encadres pour afficher
% l'intitule sur une ligne et le contenu en dessous.
\newcommand{\polyboxheading}[2]{%
  {\normalsize\bfseries #1}%
  \IfNoValueF{#2}{\ {\normalsize\bfseries -- #2}}%
}

\RenewDocumentEnvironment{Thm}{ o +b }{%
  \refstepcounter{Thm}%
  \vspace{1em}
  \begin{bclogo}[couleur=orange!20,arrondi=0.1,ombre=true,couleurOmbre=black!30,logo=\bcbook,barre=none,marge=8]{\polyboxheading{Théorème \theThm}{#1}}%
  \vspace{0.5em}
  \itshape #2
  \end{bclogo}
}{}

\RenewDocumentEnvironment{Def}{ o +b }{%
  \refstepcounter{Thm}%
  \vspace{1em}
  \begin{bclogo}[couleur=teal!15,arrondi=0.1,ombre=true,couleurOmbre=black!30,logo=\bcfleur,barre=none,marge=8]{\polyboxheading{Définition \theThm}{#1}}%
  \vspace{0.5em}
  \itshape #2
  \end{bclogo}
}{}
...
\RenewDocumentEnvironment{Prop}{ o +b }{%
  \refstepcounter{Thm}%
  \vspace{1em}
  \begin{bclogo}[couleur=cyan!15,arrondi=0.1,ombre=true,couleurOmbre=black!30,logo=\bcetoile,barre=none,marge=8]{\polyboxheading{Proposition \theThm}{#1}}%
  \vspace{0.5em}
  \itshape #2
  \end{bclogo}
}{}

\RenewDocumentEnvironment{Rmq}{ o +b }{%
  \vspace{1em}
  \begin{bclogo}[couleur=red!10,arrondi=0.1,ombre=true,couleurOmbre=black!30,logo=\bcfeuvert,barre=none,marge=8]{\polyboxheading{Remarque}{#1}}%
  \vspace{0.5em}
  \itshape #2
  \end{bclogo}
}{}
