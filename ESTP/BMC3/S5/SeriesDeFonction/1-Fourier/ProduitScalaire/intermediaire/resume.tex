...
\item On ne peut pas \og  choisir comme on veut \fg{}  : pour obtenir un produit scalaire diagonal $\langle u,v\rangle = \sum_i a_i u_i v_i$, il faut et il suffit que $a_i>0$ pour tout $i$ (sinon la positivité définie échoue).
