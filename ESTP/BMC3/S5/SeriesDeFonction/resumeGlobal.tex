...
% \input{0-Revisions/CC/CC.tex}

% \setcounter{chapter}{1}
% \chapter{Révisions sur les intégrales}
% \input{1-Fourier/Integrales/resume.tex}

% \setcounter{chapter}{2}
% \chapter{Révisions sur les complexes}
% \input{1-Fourier/Complexes/resume.tex}

% \setcounter{chapter}{3}
% \chapter{Des produits scalaires aux coefficients de Fourier}
% \input{1-Fourier/ProduitScalaire/resume.tex}

% \setcounter{chapter}{4}
% \chapter{Produit scalaire - exercices intermédiaires}
% \input{1-Fourier/ProduitScalaire/intermediaire/resume.tex}

% \setcounter{chapter}{5}
% \chapter{Contrôle continu 2}
% \input{1-Fourier/CC/index.tex}

% \chapter*{Contrôle sur les séries de Fourier}
% \input{1-Fourier/Exam/index.tex}
% \chapter*{Contrôle sur les séries de Fourier - 2eme version}
% \input{1-Fourier/Exam/Rattrapages/index.tex}

% \setcounter{chapter}{6}
% \chapter{Equations différentielles}
% \input{1-Fourier/EquationsDifferentielles/resume.tex}

\setcounter{chapter}{7}
\chapter{Intégrales impropres}
\input{1-Fourier/IntegralesGeneralisees/resume.tex}
\end{document}
