...
où $\varphi_i(x)$ sont les fonctions d'interpolation et $\alpha_i$ sont les inconnues.
    ...
    \ifthenelse{\boolean{showSolutions}}{
        \begin{solution}
            Pour chaque élément fini, on a eu besoin de calculer 5 intégrales (par symétrie de $a$). 
...
\item Donner la taille et l'expression de la matrice de rigidité élémentaire $K_e$.
    ...
    \ifthenelse{\boolean{showSolutions}}{
        \begin{solution}
            Pour chaque élément fini, on a eu besoin de calculer 9 intégrales (par symétrie de $a$). 
