...
&= \int_{-1}^1 (-3x^4-x^3+2x^2+x+1) \, dx = 0
\end{align*}
\end{minipage}
\hfill
\begin{minipage}{0.4\linewidth}
...
$$\iint_D f(x,y) \, dxdy = \iint_{\tilde{D}} f(\rho \cos \theta, \rho \sin \theta) \cdot \rho \, d\rho \, d\theta$$
où $\tilde{D}$ est le domaine en coordonnées polaires correspondant à $D$.
\end{Thm}
