...
\begin{center}
    ...
    \begin{tabular}{|c|c|c|c|c|c||c|}
        ...
        \hline
        \textbf{Barème} & 5 pts & 3 pts & 4 pts & 4 pts & 4 pts & \textbf{20 pts} \\
        \hline
    \end{tabular}
\end{center}
...
\vspace{1em}
\section*{Exercice 1 : Équations \hfill \normalfont\textit{(5 points)}}
Résoudre :
\begin{multicols}{2}
\begin{enumerate}[itemsep=0.8em]
    \item \textit{(1 pt)} $z-2i=iz+1$
    \item \textit{(1 pt)} $z^4-2z^3-z+2=0$ 
    \item \textit{(1 pt)} $2z^2-(7+3i)z+(2+4i)=0$
    \item \textit{(1 pt)} $z^4=-1$
    \item \textit{(1 pt)} $z^6=\dfrac{3}{1-i \sqrt{3}}$
\end{enumerate}
\end{multicols}
...
\section*{Exercice 2 : Lieux géométriques \hfill \normalfont\textit{(3 points)}}
Dans le plan complexe, déterminer l'ensemble des points $M$ dont l'affixe $z$ vérifie :
\begin{multicols}{3}
\begin{enumerate}[itemsep=0.5em]
    \item \textit{(1 pt)} $\arg \left( \dfrac{z}{1+i} \right )=\dfrac{\pi}{4}[2\pi]$
    \item \textit{(1 pt)} $\left|\dfrac{z+1}{z-2}\right|=1$
    \item \textit{(1 pt)} $\dfrac{2z-i}{z-2i} \in \mathbb{R}$
\end{enumerate}
\end{multicols}
...
\section*{Exercice 3 : Polynômes \hfill \normalfont\textit{(4 points)}}
\begin{enumerate}[itemsep=0.5em]
    \item \textit{(1,5 pts)} Trouver $a,b,c$ réels tel que $X^2+X+1$ divise $X^4+aX^2+bX+c$.
    \item \textit{(1 pt)} Déterminer tous les polynômes $P$ qui vérifient : $P(X^2)=(X^2+1)P(X)$
    \item \textit{(1,5 pts)} Décomposer en éléments simples : $F(X)=\dfrac{X^4}{(X^2-1)(X+3)}$
\end{enumerate}
...
\vspace{1em}
\section*{Exercice 4 : Suites \hfill \normalfont\textit{(4 points)}}
Donner une expression en fonction de $n$ puis calculer les limites des suites suivantes, définies par récurrence :

\begin{enumerate}[itemsep=0.5em]
    \item \textit{(1 pt)} $\begin{cases}
    u_0=2\\
    u_{n+1}=2u_n-6
    \end{cases}$
    
    \item \textit{(1,5 pts)} $\begin{cases}
    u_0=1, \quad u_1=0\\
    u_{n+2}=3u_{n+1}-2u_n
    \end{cases}$
    ...
    \end{cases} \qquad $ On montrera que $v_n=\dfrac{u_n-3}{u_n+1}$ est géométrique.
\end{enumerate}
...
\vspace{1em}
\section*{Exercice 5 : Barycentre \hfill \normalfont\textit{(4 points)}}
