...
async function loadThemes() {
  try {
    const response = await fetch('./js/data/themes.json');
    ...
    state.themes = THEMES.map(t => ({ id: t.id, label: t.label, done: false, score: null }));
