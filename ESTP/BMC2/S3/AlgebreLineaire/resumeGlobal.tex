...
% \input{0-Revisions/CC.tex}

% ================== Séquence 2 ==================
% \setcounter{chapter}{1}
% \chapter{Espaces vectoriels}

% \input{1-EspacesVectoriels/resume.tex}

% \setcounter{chapter}{2}
% \chapter{Familles de vecteurs}
% \input{2-FamillesDeVecteurs/resume.tex}

% \chapter{Controle continu - Espaces vectoriels}
% \input{1-EspacesVectoriels/CC/CC.tex}

% \setcounter{chapter}{2}
% \chapter{Mise au point sur la rédaction}
% \input{1-EspacesVectoriels/CC/PointRedaction/modele.tex}

\setcounter{chapter}{4}

% \chapter{Applications linéaires}
% \input{3-ApplicationsLineaires/1-Feuille-Intro/resume.tex}

% \setcounter{section}{3}
% \input{3-ApplicationsLineaires/2-MatriceDuneApplicationLineaire/resume.tex}

% \setcounter{section}{5}
% \input{3-ApplicationsLineaires/3-Matrice-de-Passage/resume.tex}

\setcounter{section}{7}
\input{3-ApplicationsLineaires/4-Noyau-Image/resume.tex}

% \chapter{Contrôle continu - Applications linéaires}
% \input{3-ApplicationsLineaires/2-MatriceDuneApplicationLineaire/cc.tex}
\end{document}
