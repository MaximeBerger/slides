...
\og  Quand, pendant la Grande Dépression, les ouvriers pauvres ont quitté l'Oklahoma pour la Californie, le niveau intellectuel moyen des deux États a augmenté. \fg{}  Cette citation est attribuée au comédien américain originaire d'Oklahoma : Will Rogers.
...
\begin{itemize}
    ...
    \[
    \begin{aligned}
        \sigma(x)^2 =\; & \frac{1}{12} \bigg(
            1 \times (8 - 12.5)^2 \\
        &\quad +\, 2 \times (10 - 12.5)^2 \\
        &\quad +\, 4 \times (12 - 12.5)^2 \\
        &\quad +\, 1 \times (14 - 12.5)^2 \\
        &\quad +\, 4 \times (15 - 12.5)^2
        \bigg)
        \approx 5.08
    \end{aligned}
    \]
...
Soit $n$ un entier supérieur à 2. Considérons $n$ points de $\mathbb{R}^2$, $(x_1, y_1), \ldots, (x_n, y_n)$ non alignés verticalement. On cherche la droite qui \og  approxime \fg{}  au mieux ces $n$ points. Si on note $y = ax + b$, l'équation d'une droite, on cherche à minimiser l'erreur
\[
...
Retenons que lorsque le coefficient de corrélation linéaire est proche de $\pm 1$, la droite de régression approche bien le nuage de points. Dans ce cas, on peut modéliser la dépendance et faire des prédictions. De plus, si le coefficient de corrélation est positif, les données $x_i$ \og  auront tendance \fg{}  à augmenter lorsque $y_i$ augmente et inversement si le coefficient est négatif.
\end{Rmq}
