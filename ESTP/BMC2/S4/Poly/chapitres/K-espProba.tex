...
On tire successivement et avec remise des boules dans une urne contenant 1 rouge et 9 blanches. On note $R_n$ l'évènement \og  la $n$-ième boule tirée est rouge \fg{} . Traduire en langage courant les évènements suivants :\\
\begin{multicols}{3}
\begin{itemize}
...
Deux joueurs A et B s'affrontent dans un jeu de dés. On lance deux dés équilibrés jusqu'à ce qu'une somme égale à 5 ou 7 apparaisse. Le joueur A gagne si la somme 5 apparaît et le joueur B gagne si c'est la somme 7 qui apparaît. On note $A_n$ l'évènement \og  le joueur A gagne au $n$-ième tour \fg{}  et $B_n$ l'évènement \og  le joueur B gagne au $n$-ième tour \fg{} . On pose $G_n = A_n \cup B_n$. On note $A$ (resp. $B$) l'évènement \og  le joueur $A$ (resp. $B$) gagne \fg{} .
\begin{enumerate}
...
\begin{itemize}
    \item $R_n$ l'évènement \og  la $n$-ième boule tirée est rouge \fg{}  ;
    \item $A_n$ l'évènement \og  On ne tire aucune boule rouge au cours des $n$ premiers tirages. \fg{}  ;
    \item $B$ l'évènement \og  On tire au moins une boule rouge lors de la suite infinie de tirages \fg{} .
\end{itemize}
\begin{enumerate}
...
\begin{itemize}
    ...
    \item $A_k$ l'évènement \og  le joueur a encore 2 Euros à l'issue du $k$-ième lancer \fg{} .
    \item $B_k$ l'évènement \og  le joueur a encore exactement 1 Euro à l'issue du $k$-ième lancer \fg{} .
    \item $R_k$ l'évènement \og  le joueur a 0 euros (et est donc ruiné) à l'issue du $k$-ième lancer \fg{} .
    \item $R$ l'évènement \og  le joueur finit ruiné \fg{}  autrement dit \og  le jeu finit par s'arrêter \fg{} .
\end{itemize}
...
On note $A_n$ l'évènement \og  le joueur n'a toujours pas gagné à l'issue de la $n$-ième étape \fg{} .
\begin{enumerate}
